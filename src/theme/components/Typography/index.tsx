...
const setConfig = (sizeVariations: any, defaultTag?: string) => ({
  shouldForwardProp: (prop: any) => prop !== defaultTag && !Object.keys(sizeVariations).includes(prop)
});

export const Heading = styled.h1.withConfig(setConfig(headingSizeVariations, 'h1')).attrs(setAttrs('h1'))<
...
export const Text = styled.div.withConfig(setConfig(bodySizeVariations)).attrs(setAttrs('div'))<
...
export const Label = styled.div.withConfig(setConfig(labelSizeVariations)).attrs(setAttrs('span'))<
